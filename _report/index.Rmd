...
Since adding new machine types, many updates need to be made to report generation in order to accommodate the extra dimension of the benchmark. One area where this maintenance has not yet occured is with error reporting. Please be patient while this work gets tended to, most error are out of memory errors. If you see an error that doesn't make sense and you are sure is not an out of memory error feel free to file an issue.
